...
med_model_BuyerTrust <- mediate(model_m, model_y_trust, treat = "Condition", mediator = "BuyerUnethicalityIndex", boot = TRUE, boot.ci.type = "perc", sims = 1000) 

print(summary(med_model_BuyerTrust))
ggplot(med_model_BuyerTrust, aes(x = )
```
...
summary(med_model_FutureNegotiation)
```
