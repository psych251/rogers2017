...
Please note that the planned sample size is subject to change depending upon the results of a power analysis. For now, I will plan to recruit the same amount of participants that were recruited in the original study.
...
Participants' ratings of the extent to which the Buyer's answer, as well as the Buyer themselves, was "unethical," "dishonest," and "immoral" will be averaged to create two "ethicality indexes." Participants' ratings of how "creative," "innovative," and "original" the Buyer's answer was will be excluded. 
...
The analyses as specified in the analysis plan. Ordinal logistic regressions will be conducted in order to determine the effect of condition (if any) on participants' ratings of the Buyer's ethicality, their trust in the Buyer, and their likelihood of engaging in a future negotiation with the Buyer.
