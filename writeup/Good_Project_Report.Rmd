...
med_model_BuyerTrust <- mediate(model_m, model_y_trust, treat = "Condition", mediator = "BuyerUnethicalityIndex", boot = TRUE, boot.ci.type = "perc", sims = 1000) # generates model 
...
med_model_FutureNegotiation <- mediate(model_m, model_y_future_negotiation, treat = "Condition", mediator = "BuyerUnethicalityIndex", boot = TRUE, boot.ci.type = "perc", sims = 1000) # 
...
print(summary(med_model_BuyerTrust_honest_lie))
...
print(summary(med_model_BuyerTrust_lie_palter))
...
print(summary(med_model_BuyerTrust_honest_palter))
```
...
print(summary(med_model_FutureNegotiation_honest_lie))
...
print(summary(med_model_FutureNegotiation_lie_palter))
...
print(summary(med_model_FutureNegotiation_honest_palter))
```
...
summary(med_fit_buyer_trust, standardized = TRUE)
