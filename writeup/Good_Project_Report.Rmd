...
mydata_buyer_unethicality_plot <- ggplot(buyer_unethicality_means, aes(x=Condition, y=buyer_unethicality_mean, fill=Condition)) +
  ...
  theme_few() +
  theme(panel.border = element_blank(), axis.title.x = element_blank(), legend.position = "none") # plot of condition means for ratings of Buyer ethicality
...
mydata_answer_unethicality_plot <- ggplot(answer_unethicality_means, aes(x=Condition, y=answer_unethicality_mean, fill=Condition)) +
  ...
  theme_few() +
  theme(panel.border = element_blank(), axis.title.x = element_blank(), legend.position = "none") # plot of condition means for ratings of the ethicality of the Buyer's answer
...
mydata_buyer_trust_plot <- ggplot(buyer_trust_means, aes(x=Condition, y=BuyerTrust_mean, fill=Condition)) +
  ...
  theme_few() +
  theme(panel.border = element_blank(), axis.title.x = element_blank(), legend.position = "none") # plot of condition means for ratings of trust in the Buyer
...
mydata_future_negotiation_plot <- ggplot(future_negotiation_means, aes(x=Condition, y=FutureNegotiation_mean, fill=Condition)) +
  ...
  theme_few() +
  theme(panel.border = element_blank(), axis.title.x = element_blank(), legend.position = "none") # plot of condition means for ratings of likelihood of engaging in a future negotiation with the Buyer
```
...
side_by_side_buyer_unethicality_plots <- plot_grid(mydata_buyer_unethicality_plot, originaldata_buyer_unethicality_plot, labels = c("Replication", "Original"), label_x = .25, hjust = -.15, vjust = 1.1)
...
side_by_side_answer_unethicality_plots <- plot_grid(mydata_answer_unethicality_plot, originaldata_answer_unethicality_plot, labels = c("Replication", "Original"), label_x = .25, hjust = -.15, vjust = 1.1)
...
```{r, echo=FALSE}
side_by_side_BuyerTrust_plots <- plot_grid(mydata_buyer_trust_plot, originaldata_BuyerTrust_plot, labels = c("Replication", "Original"), label_x = .25, hjust = -.15, vjust = 1.1)
...
```{r, echo=FALSE}
side_by_side_FutureNegotiation_plots <- plot_grid(mydata_future_negotiation_plot, originaldata_FutureNegotiation_plot, labels = c("Replication", "Original"), label_x = .25, hjust = -.15, vjust = 1.1)
