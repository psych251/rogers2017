...
med_fit_buyer_trust <- sem(buyer_trust_model, data = mediation_data, se = "bootstrap")
summary(med_fit_buyer_trust, standardized = TRUE) # generates mediation model
...
med_fit_future_negotiation <- sem(future_negotiation_model, data = mediation_data, se = "bootstrap")
summary(med_fit_buyer_trust, standardized = TRUE) # generates mediation model
